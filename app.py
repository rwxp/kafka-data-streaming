...
# Se encarga de informar si se distribuyo un mensaje o no.
# Printea a que topic correspondia el mensaje, en cual partition fue distribuido y en que offset de la partition estuvo.
...
def bid():
    ...
    if request.method == 'POST':
        ...
        json_serializer = JSONSerializer(
            my_schema, schema_registry_client, to_dict=None)
        ...
        try:
            ...
            producer.produce(topic=topic,
                             ...
                             value=json_serializer(
                                 response, SerializationContext(topic, MessageField.VALUE)),
